...
const docTemplate = `{
    ...
    "paths": {
        "/search": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Search results retrieved successfully. Items are a flat mixed list of programs and episodes.",
                    ...
                    "500": {
                        ...
                        "examples": {
                            "application/json": { "error": "search failed" }
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": { "$ref": "#/definitions/model.ProgramDetail" },
                        "examples": {
                            "application/json": {
                                "id": "123e4567-e89b-12d3-a456-426614174000",
                                "title": "فنجان",
                    ...
                    "400": {
                        ...
                        "schema": { "$ref": "#/definitions/object" },
                        "examples": {
                            "application/json": { "error": "id required" }
                        }
                    },
                    "404": {
                        ...
                        "schema": { "$ref": "#/definitions/object" },
                        "examples": {
                            "application/json": { "error": "program not found" }
                        }
                    },
                    "500": {
                        "description": "Internal server error — Elasticsearch or cache unavailable",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": { "$ref": "#/definitions/model.EpisodeDetail" },
                        "examples": {
                            "application/json": {
                                "id": "223e4567-e89b-12d3-a456-426614174000",
                                "title": "الحلقة الأولى: البداية",
                    ...
                    "404": {
                        ...
                        "schema": { "$ref": "#/definitions/object" },
                        "examples": {
                            "application/json": { "error": "episode not found" }
                        }
                    },
                    "500": {
                        "description": "Internal server error — Elasticsearch or cache unavailable",
    ...
    "definitions": {
        ...
        "model.SearchItem": {
            "type": "object",
            "description": "A single item in unified search results. Always has type, id, title. Program-only fields (programType, category, language, coverImageUrl) are present when type=program. Episode-only fields (programId, thumbnailUrl, durationInSeconds, episodeNumber, seasonNumber, publicationDate) are present when type=episode.",
            "properties": {
                "type": {
                    "type": "string",
        ...
        "model.ProgramDetail": {
            ...
            "properties": {
                ...
                "episodes": {
                    ...
                    "items": { "$ref": "#/definitions/model.EpisodeSummary" }
                }
            }
        },
        ...
        "model.EpisodeDetail": {
            ...
            "properties": {
                ...
                "program": {
                    ...
                    "description": "Parent program summary for breadcrumb/back-link rendering"
                }
            }
        }
    }
